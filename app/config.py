...
Re-exports configuration from gofr_common.config with GOFR_DOC prefix.
"""
...
class Config(BaseConfig):
    """Project-specific Config with GOFR_DOC prefix"""

    _env_prefix = _ENV_PREFIX


def get_settings(reload: bool = False, require_auth: bool = True) -> Settings:
    """Get settings with GOFR_DOC prefix"""
