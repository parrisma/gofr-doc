...
class FragmentInstance:
    ...
    def __init__(self, fragment_id: str, parameters: Optional[dict] = None,
                 fragment_instance_guid: Optional[str] = None, created_at: Optional[str] = None):
...
class DocumentSession:
    ...
    def __init__(self, session_id: str, template_id: str, created_at: str, updated_at: str,
                 group: str,  # Mandatory - comes from template metadata
                 global_parameters: Optional[dict] = None, fragments: Optional[List[dict]] = None):
        ...
        if fragments:
            for frag in fragments:
                if isinstance(frag, dict):
                    ...
                    if frag_id:
                        self.fragments.append(FragmentInstance(
                            fragment_id=frag_id,
...
class GetDocumentOutput:
    ...
    def __init__(self, session_id: str, format: OutputFormat, style_id: str, 
...
class SessionFragmentInfo:
    ...
    def __init__(self, fragment_instance_guid: str, fragment_id: str, fragment_name: str,
                 position: int, parameters: Optional[dict] = None):
        self.fragment_instance_guid = fragment_instance_guid
        self.fragment_id = fragment_id
...
class AddFragmentOutput:
    ...
    def __init__(self, session_id: str, fragment_instance_guid: str, fragment_id: str,
...
class CreateDocumentSessionInput:
    ...
    def __init__(self, template_id: str, group: str = "default", token: Optional[str] = None):
        self.template_id = template_id
        self.group = group
        self.token = token
...
class AddFragmentInput:
    ...
    def __init__(self, session_id: str, fragment_id: str, parameters: dict,
                 position: Optional[str] = None, token: Optional[str] = None):
        self.session_id = session_id
        self.fragment_id = fragment_id
        self.parameters = parameters
        self.position = position
...
class GetDocumentInput:
    ...
    def __init__(self, session_id: str, format: str, style_id: Optional[str] = None, 
...
class FragmentDetailsOutput:
    ...
    def __init__(self, template_id: str, fragment_id: str, name: str, description: str,
...
class ErrorResponse:
    ...
    def __init__(self, error_code: str, message: str, recovery_strategy: str,
