#!/bin/bash
# Build the gofr-doc base Docker image
# Usage: ./build-base.sh [--no-cache]
#
# This creates gofr-doc_base:latest by tagging gofr-base:latest
...
TARGET_IMAGE="gofr-doc_base:latest"

echo "======================================================================="
echo "Building GOFR-DOC Base Image"
echo "======================================================================="
...
# Tag the base image for gofr-doc
...
echo ""
echo "Image size:"
docker images "gofr-doc_base" --format "table {{.Repository}}\t{{.Tag}}\t{{.Size}}"
